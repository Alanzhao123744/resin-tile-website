...
const i18n = {
  zh: {
    ...
    hero_overline: '优质屋面瓦', hero_headline: '<span style="color:#D9A64A">升华</span>每一片屋顶。<span style="color:#D9A64A">点亮</span>每一个家。', hero_tagline: '创新材料，卓越耐久。<br>坚固持久，激励人心。', hero_cta: '查看产品', hero_badge_warranty: '年<br>质保',
    ...
    contact_title: '工厂询价', contact_subtitle: '发送产品、数量、颜色和目的港详情。销售团队将在 <strong style="color:var(--acc)">12 小时内</strong> 回复报价与交期。',
    ...
    form_message: '您的留言 *', form_submit: '立即发送询价',
  ...
  en: {
    ...
    hero_overline: 'Premium Roof Tiles', hero_headline: '<span style="color:#D9A64A">Elevate</span> Every Roof. <span style="color:#D9A64A">Enhance</span> Every Home.', hero_tagline: 'Innovation materials. Superior durability.<br>Built to withstand. Built to inspire.', hero_cta: 'Explore products', hero_badge_warranty: 'year<br>warranty',
    ...
    contact_title: 'Request Factory Quote', contact_subtitle: 'Send product, quantity, color, and destination details. Our sales team replies with pricing and lead time within <strong style="color:var(--acc)">12 hours</strong>.',
    ...
    form_message: 'Your Message *', form_submit: 'Send Inquiry Now',
...
document.getElementById('contactForm').addEventListener('submit', e => {
  ...
  setTimeout(() => {
    ...
    if (!s || !s.classList.contains('form-success')) {
      ...
      s.innerHTML = `<div class="form-success__icon"><svg class="icon icon--xl"><use href="#i-check"/></svg></div><h3>${i18n[lang].form_success_title}</h3><p>${i18n[lang].form_success_text}</p>`;
